 ...
 * and applies each update via {@link PropertyManager#store(String, Object)}.
...
public final class SocketToPropertyManagerBridge {
     ...
     * {@link PropertyManager#store(String, Object)} for each message.
    ...
    public void processStream() throws IOException {
        ...
        while ((opt = reader.readMessage()).isPresent()) {
            ...
            propertyManager.store(msg.getKey(), msg.getValue());
        }
    }
}
